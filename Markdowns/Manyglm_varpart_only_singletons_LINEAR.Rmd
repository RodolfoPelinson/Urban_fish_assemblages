...
predictors <- list(estrutura = estrutura,
                  agua = agua,
                   bacia = bacia,
                   urb =  urb,
                   esp = esp_FS$new_x)
...
bacia_upper_coefs <- bacia_coefs1 + bacia_IC_coefs1
bacia_lower_coefs <- bacia_coefs1 - bacia_IC_coefs1
...
bacia_coefs_partial <- varpart_peixes$models$`bacia-urb`$coefficients[2,]
bacia_IC_coefs_partial <- varpart_peixes$models$`bacia-urb`$stderr.coefficients[2,] * qnorm(0.975)
bacia_upper_coefs_partial <- bacia_coefs_partial + bacia_IC_coefs_partial
bacia_lower_coefs_partial <- bacia_coefs_partial - bacia_IC_coefs_partial

bacia_2_coefs_partial <- varpart_peixes$models$`bacia-urb`$coefficients[3,]
bacia_2_IC_coefs_partial <- varpart_peixes$models$`bacia-urb`$stderr.coefficients[3,] * qnorm(0.975)
bacia_2_upper_coefs_partial <- bacia_2_coefs_partial + bacia_2_IC_coefs_partial
bacia_2_lower_coefs_partial <- bacia_2_coefs_partial - bacia_2_IC_coefs_partial
...
close.screen(all.screens = TRUE)
split.screen(matrix(c(0,0.15,0.5,1,
                      0.15,0.2714286,0.5,1,
                      0.2714286,0.3928572,0.5,1,
                      0.3928572,0.5142858,0.5,1,
                      0.5142858,0.6357144,0.5,1,
                      0.6357144,0.757143,0.5,1,
                      0.757143,0.8785716,0.5,1,
                      0.8785716,1,0.5,1,
                      ...
                      0.8785716,1,0,0.5), ncol = 4, nrow = 16, byrow = TRUE))
...
My_coefplot(mles = agua_2_coefs, upper = agua_2_upper_coefs,
            ...
            cex_sig = 1.5, species_labels = FALSE, yaxis_font = 3)
title(xlab = "Water", cex.lab = 1, line = 2)
title(xlab = "parameters PC2", cex.lab = 1, line = 3)
...
My_coefplot(mles = est_coefs_partial, upper = est_upper_coefs_partial,
            ...
            cex_sig = 1.5, species_labels = names, yaxis_font = 3, at.xaxis = c(-50, -25, 0, 25, 50, 75))
title(xlab = "Stream", cex.lab = 1, line = 2)
title(xlab = "structure PC1", cex.lab = 1, line = 3)
...
My_coefplot(mles = est_2_coefs_partial, upper = est_2_upper_coefs_partial,
            ...
            cex_sig = 1.5, species_labels = FALSE, yaxis_font = 3, at.xaxis = c(-50, -25, 0, 25, 50, 75))
title(xlab = "Stream", cex.lab = 1, line = 2)
title(xlab = "structure PC2", cex.lab = 1, line = 3)
...
My_coefplot(mles = agua_coefs_partial, upper = agua_upper_coefs_partial,
            ...
            cex_sig = 1.5, species_labels = FALSE, yaxis_font = 3, at.xaxis = c(-40, -20, 0, 20, 40, 60))
title(xlab = "Water", cex.lab = 1, line = 2)
title(xlab = "parameters PC1", cex.lab = 1, line = 3)
...
My_coefplot(mles = agua_2_coefs_partial, upper = agua_2_upper_coefs_partial,
            ...
            cex_sig = 1.5, species_labels = FALSE, yaxis_font = 3, at.xaxis = c(-20, -10, 0, 10, 20, 30))
title(xlab = "Water", cex.lab = 1, line = 2)
title(xlab = "parameters PC2", cex.lab = 1, line = 3)
letters(x = 12, y = 94, "k)", cex = 1.5)


screen(15, new = FALSE)
par(mar = c(4,2,2,0.1))
My_coefplot(mles = bacia_coefs_partial, upper = bacia_upper_coefs_partial,
            lower = bacia_lower_coefs_partial, col_sig = "#FFBB78",
            cex_sig = 1.5, species_labels = FALSE, yaxis_font = 3, xlim = c(-10,60), at.xaxis = c(-20,0, 20, 40, 60))
title(xlab = "Watershed", cex.lab = 1, line = 2)
title(xlab = "descriptors PC1", cex.lab = 1, line = 3)
letters(x = 12, y = 94, "l)", cex = 1.5)


screen(16, new = FALSE)
par(mar = c(4,2,2,0.1))
My_coefplot(mles = bacia_2_coefs_partial, upper = bacia_2_upper_coefs_partial,
            lower = bacia_2_lower_coefs_partial, col_sig = "#FFBB78",
            cex_sig = 1.5, species_labels = FALSE, yaxis_font = 3, xlim = c(-10,30), at.xaxis = c(-20, -10, 0, 10, 20, 30))
title(xlab = "Watershed", cex.lab = 1, line = 2)
title(xlab = "descriptors PC2", cex.lab = 1, line = 3)
letters(x = 12, y = 94, "m)", cex = 1.5)
...
newdata_est1 <- data.frame(est_PC1 = seq(from = min(predictors$estrutura$est_PC1), to = max(predictors$estrutura$est_PC1), length.out = 100),
                          est_PC2 = rep(median(predictors$estrutura$est_PC2),100))
predicted_est1 <- predict.manyglm(varpart_peixes$models$estrutura, newdata = newdata_est1, type = "response")
...
newdata_est2 <- data.frame(est_PC2 = seq(from = min(predictors$estrutura$est_PC2), to = max(predictors$estrutura$est_PC2), length.out = 100),
                          est_PC1 = rep(median(predictors$estrutura$est_PC1),100))
predicted_est2 <- predict.manyglm(varpart_peixes$models$estrutura, newdata = newdata_est2, type = "response")
...
newdata_agua1 <- data.frame(agua_PC1 = seq(from = min(predictors$agua$agua_PC1), to = max(predictors$agua$agua_PC1), length.out = 100),
                           agua_PC2 = rep(median(predictors$agua$agua_PC2),100))
predicted_agua1 <- predict.manyglm(varpart_peixes$models$agua, newdata = newdata_agua1, type = "response")

line_tp_agua1 <- rep(5, ncol(predicted_agua1))
line_tp_agua1[which(agua_lower_coefs > 0)] <- 1
line_tp_agua1[which(agua_upper_coefs < 0)] <- 1

lwd_agua1 <- rep(3, ncol(predicted_agua1))
lwd_agua1[which(agua_lower_coefs > 0)] <- 4
lwd_agua1[which(agua_upper_coefs < 0)] <- 4

###################################################

newdata_agua2 <- data.frame(agua_PC2 = seq(from = min(predictors$agua$agua_PC2), to = max(predictors$agua$agua_PC2), length.out = 100),
                           agua_PC1 = rep(median(predictors$agua$agua_PC1),100))
predicted_agua2 <- predict.manyglm(varpart_peixes$models$agua, newdata = newdata_agua2, type = "response")

line_tp_agua2 <- rep(5, ncol(predicted_agua2))
line_tp_agua2[which(agua_2_lower_coefs > 0)] <- 1
line_tp_agua2[which(agua_2_upper_coefs < 0 )] <- 1

lwd_agua2 <- rep(3, ncol(predicted_agua2))
lwd_agua2[which(agua_2_lower_coefs > 0)] <- 4
lwd_agua2[which(agua_2_upper_coefs < 0 )] <- 4


###################################################

newdata_bacia1 <- data.frame(bacia_PC1 = seq(from = min(predictors$bacia$bacia_PC1), to = max(predictors$bacia$bacia_PC1), length.out = 100),
                           bacia_PC2 = rep(median(predictors$bacia$bacia_PC2),100))
...
line_tp_bacia1[which(bacia_lower_coefs > 0)] <- 1
line_tp_bacia1[which(bacia_upper_coefs < 0)] <- 1

lwd_bacia1 <- rep(3, ncol(predicted_bacia1))
lwd_bacia1[which(bacia_lower_coefs > 0)] <- 4
lwd_bacia1[which(bacia_upper_coefs < 0)] <- 4

###################################################

modelo_bacia <- manyglm(assembleia_peixes_rm_mv ~ bacia_PC1 + bacia_PC2, data = predictors$bacia, family = "negative.binomial")
...
newdata_bacia2 <- data.frame(bacia_PC2 = seq(from = min(predictors$bacia$bacia_PC2), to = max(predictors$bacia$bacia_PC2), length.out = 100),
                           bacia_PC1 = rep(median(predictors$bacia$bacia_PC1),100))

predicted_bacia2 <- predict.manyglm(modelo_bacia, newdata = newdata_bacia2, type = "response")

line_tp_bacia2 <- rep(5, ncol(predicted_bacia2))
line_tp_bacia2[which(bacia_2_lower_coefs > 0)] <- 1
line_tp_bacia2[which(bacia_2_upper_coefs < 0 )] <- 1

lwd_bacia2 <- rep(3, ncol(predicted_bacia2))
lwd_bacia2[which(bacia_2_lower_coefs > 0)] <- 4
lwd_bacia2[which(bacia_2_upper_coefs < 0 )] <- 4
...
for(i in 1:ncol(predicted_est[,NOT_poecilidae])){
  lines(x = newdata_est$est_PC1, y = predicted_est1[,NOT_poecilidae][,i], col = "white", lwd = 5)
  lines(x = newdata_est$est_PC1, y = predicted_est1[,NOT_poecilidae][,i], col = colors[NOT_poecilidae][i], lwd = lwd_est[NOT_poecilidae][i], lty = line_tp_est[NOT_poecilidae][i])
}
...
for(i in 1:ncol(predicted_est[,poecilidae])){
  lines(x = newdata_est$est_PC1, y = predicted_est1[,poecilidae][,i], col = "white", lwd = 5)
  lines(x = newdata_est$est_PC1, y = predicted_est1[,poecilidae][,i], col = colors[poecilidae][i], lwd = lwd_est[poecilidae][i], lty = line_tp_est[poecilidae][i])
}
