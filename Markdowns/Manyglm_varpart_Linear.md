...
![](Manyglm_varpart_Linear_files/figure-gfm/unnamed-chunk-10-1.png)<!-- -->
...
![](Manyglm_varpart_Linear_files/figure-gfm/unnamed-chunk-11-1.png)<!-- -->
...
``` r
full_model_env <- varpart_peixes$R2_models$`structural_complexity-water_quality-hydrology`
full_model_env
```
...
![](Manyglm_varpart_Linear_files/figure-gfm/unnamed-chunk-24-1.png)<!-- -->
...
![](Manyglm_varpart_Linear_files/figure-gfm/unnamed-chunk-26-1.png)<!-- -->
...
![](Manyglm_varpart_Linear_files/figure-gfm/unnamed-chunk-29-1.png)<!-- -->
...
![](Manyglm_varpart_Linear_files/figure-gfm/unnamed-chunk-30-1.png)<!-- -->
...
mtext("Narrower channels", side = 1, line = 0 , adj = 0, cex = 0.8, at = min(newdata_hydrology1$hydrology_PC1)-0.4)
#mtext("Circular catchments", side = 1, line = 0.75 , adj = 0, cex = 0.8, at = min(newdata_hydrology1$hydrology_PC1)-0.4)
...
![](Manyglm_varpart_Linear_files/figure-gfm/unnamed-chunk-32-1.png)<!-- -->
