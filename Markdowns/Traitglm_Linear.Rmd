...
Now we put these traits in a PCoA to reduce dimensionality since many traits are correlated
...
```{r,   fig.width = 9, fig.height = 8, dpi = 600, dev.args= list(pointsize=13), eval = TRUE, echo = TRUE}
