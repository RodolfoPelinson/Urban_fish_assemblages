...
```
    ...
    ##  [4] "larg_media"                                         
    ##  [5] "velocidade_media"                                   
    ##  [6] "comp_ecotono_rocha"                                 
    ##  [7] "comp_ecotono_solo_exposto"                          
    ##  [8] "comp_ecotono_concreto"                              
    ##  [9] "substrato_silte"                                    
    ## [10] "substrato_areia"                                    
    ## [11] "substrato_cascalho"                                 
    ## [12] "substrato_seixo"                                    
    ## [13] "substrato_rocha"                                    
    ## [14] "substrato_litter"                                   
    ## [15] "substrato_litter_grosseiro"                         
    ## [16] "substrato_galhos_grandes_troncos"                   
    ## [17] "substrato_lodo"                                     
    ## [18] "substrato_concreto"                                 
    ## [19] "substrato_argila"                                   
    ## [20] "substrato_entulho"                                  
    ## [21] "substrato_arame"                                    
    ## [22] "substrato_matacao"                                  
    ## [23] "substrato_galhos_pequenos"                          
    ## [24] "tipo_de_canal_corredeira"                           
    ## [25] "tipo_de_canal_poco"                                 
    ## [26] "tipo_de_canal_cascata"                              
    ## [27] "tipo_de_canal_fluxo_continuo"                       
    ## [28] "pert_zona_riparia_cano_esgoto"                      
    ## [29] "pert_zona_riparia_entulho"                          
    ## [30] "pert_zona_riparia_lixo_inorganico"                  
    ## [31] "pert_zona_riparia_lixo_organico"                    
    ## [32] "pert_zona_riparia_animais_criacao"                  
    ## [33] "pert_zona_riparia_construcoes"                      
    ## [34] "pert_zona_riparia_bomba"                            
    ## [35] "comp_zona_riparia_veg_arborea"                      
    ## [36] "comp_zona_riparia_veg_arbustiva"                    
    ## [37] "comp_zona_riparia_veg_herbacea"                     
    ## [38] "comp_zona_riparia_veg_herb_ereta"                   
    ## [39] "comp_zona_riparia_graminea"                         
    ## [40] "comp_zona_riparia_solo_exposto"                     
    ## [41] "comp_zona_riparia_area_alagada"                     
    ## [42] "comp_zona_riparia_calcada"                          
    ## [43] "comp_zona_riparia_asfalto"                          
    ## [44] "comp_zona_riparia_plantacao"                        
    ## [45] "comp_zona_riparia_pastagem"                         
    ## [46] "comp_zona_riparia_constucao"                        
    ## [47] "comp_zona_riparia_canal_vert"                       
    ## [48] "comp_zona_riparia_grade_arame"                      
    ## [49] "estrutura_dentro_do_canal_pedaco_de_madeira_grande" 
    ## [50] "estrutura_dentro_do_canal_pedaco_de_madeira_pequeno"
    ## [51] "estrutura_dentro_do_canal_raizes_vivas"             
    ## [52] "estrutura_dentro_do_canal_banco_de_folhas"          
    ## [53] "estrutura_dentro_do_canal_vegetacao_pendurada"      
    ## [54] "estrutura_dentro_do_canal_banco_de_terra"           
    ## [55] "estrutura_dentro_do_canal_matacao"                  
    ## [56] "estrutura_dentro_do_canal_macrofita"                
    ## [57] "estrutura_dentro_do_canal_cianobacterias"           
    ## [58] "estrutura_dentro_do_canal_herb_ereta"               
    ## [59] "estrutura_dentro_do_canal_graminea"                 
    ## [60] "estrutura_dentro_do_canal_entulho"                  
    ## [61] "estrutura_dentro_do_canal_lixo_inorganico"          
    ## [62] "encaixe_rocha"                                      
    ## [63] "encaixe_vale"                                       
    ## [64] "encaixe_terraco"                                    
    ## [65] "encaixe_alt_antropica"                              
    ## [66] "encaixe_sem_feicoes"                                
    ## [67] "tipo_de_encaixe_vale_em_U"                          
    ## [68] "tipo_de_encaixe_concavo"                            
    ## [69] "tipo_de_encaixe_encaixado_canalizado"               
    ## [70] "tipo_de_encaixe_vale_assimetrico"                   
    ## [71] "nova_descarga_sal"                                  
    ## [72] "comp_ecotono_arborea"                               
    ## [73] "comp_ecotono_raizes"                                
    ## [74] "comp_ecotono_grasses"                               
    ## [75] "comp_ecotono_aquatic_veg"                           
    ## [76] "comp_ecotono_anthropic_complex_est"
...
```
    ...
    ## PC8   1.77938699       0.04
    ## PC9   1.66339210       0.04
    ## PC10  1.45901756       0.03
    ## PC11  1.27210106       0.03
    ## PC12  1.16764771       0.03
    ## PC13  1.03650378       0.02
    ## PC14  1.01555238       0.02
    ## PC15  0.88923037       0.02
    ## PC16  0.81923336       0.02
    ## PC17  0.68963933       0.02
    ## PC18  0.57219176       0.01
    ## PC19  0.48748631       0.01
    ## PC20  0.36765969       0.01
    ## PC21  0.33564662       0.01
    ## PC22  0.25816802       0.01
    ## PC23  0.21669821       0.01
    ## PC24  0.17062079       0.00
    ## PC25  0.15082468       0.00
    ## PC26  0.07199548       0.00
    ## PC27  0.06359095       0.00
    ## PC28  0.03398458       0.00
    ## PC29  0.01264329       0.00
...
```
    ...
    ## PC1  2.871054108       0.29                            0.29
    ## PC2  2.246200658       0.22                            0.51
    ## PC3  1.223986122       0.12                            0.63
    ## PC4  1.078188409       0.11                            0.74
    ## PC5  0.990495181       0.10                            0.84
    ## PC6  0.679824003       0.07                            0.91
    ## PC7  0.470892057       0.05                            0.96
    ## PC8  0.319846736       0.03                            0.99
    ## PC9  0.111492405       0.01                            1.00
    ## PC10 0.008020321       0.00                            1.00
...
```
    ...
    ##                                              PC1          PC2
    ## larg_media                            0.45171087  0.036361729
    ## nova_descarga_sal                     0.30836194  0.026005646
    ## prof_media                           -0.04957695  0.538342228
    ## sinuosidade                          -0.26833374  0.252735805
    ## tipo_de_encaixe_encaixado_canalizado  0.36823333 -0.343231712
    ## velocidade_media                      0.15247412 -0.463592355
    ## Area_ha                               0.38254035  0.001225659
    ## Ic                                   -0.38982326 -0.374456788
    ## Kc                                    0.37386182  0.388502873
...
for(i in 1:nrow(water_quality_loadings_filtrados_new_rp)){
  text_contour(x = water_quality_loadings_filtrados_new_rp[i,1], y = water_quality_loadings_filtrados_new_rp[i,2], labels = names_water_quality[i], cex = cex_variables, col = "white", font = 2, thick = 0.004)
text(x = water_quality_loadings_filtrados_new_rp[i,1], y = water_quality_loadings_filtrados_new_rp[i,2], labels = names_water_quality[i], cex = cex_variables, col = "black", font = 2)
}
...
title(main = "a) Water quality", line = 0.5, adj = 0, cex.main = 1.5)


###################### CHANNEL ENVIRONMENTAL STRUCTURE
...
for(i in 1:nrow(structural_complexity_loadings_filtrados_new_rp)){
  text_contour(x = structural_complexity_loadings_filtrados_new_rp[i,1], y = structural_complexity_loadings_filtrados_new_rp[i,2], labels = names_structural_complexity[i], cex = cex_variables, col = "white", font = 2, thick = 0.004)
  
text(x = structural_complexity_loadings_filtrados_new_rp[i,1], y = structural_complexity_loadings_filtrados_new_rp[i,2], labels = names_structural_complexity[i], cex = cex_variables, col = "black", font = 2)
}
...
title(main = "b) Channel environmental structure", line = 0.5, adj = 0, cex.main = 1.5)
...
for(i in 1:nrow(hydrology_loadings_filtrados_new_rp)){
  text_contour(x = hydrology_loadings_filtrados_new_rp[i,1], y = hydrology_loadings_filtrados_new_rp[i,2], labels = names_hydrology[i], cex = cex_variables, col = "white", font = 2, thick = 0.004)
text(x = hydrology_loadings_filtrados_new_rp[i,1], y = hydrology_loadings_filtrados_new_rp[i,2], labels = names_hydrology[i], cex = cex_variables, col = "black", font = 2)
}
