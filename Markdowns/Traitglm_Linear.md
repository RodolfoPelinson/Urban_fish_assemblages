...
trait_urb_coef_CI <- Model_trait_urb_trait$stderr.coefficients[(nlines-1):nlines,]*qnorm(0.975)
...
trait_structural_complexity_coef_CI <- Model_trait_structural_complexity_trait$stderr.coefficients[(nlines-3):nlines,]*qnorm(0.975)
...
trait_water_quality_coef_CI <- Model_trait_water_quality_trait$stderr.coefficients[(nlines-3):nlines,]*qnorm(0.975)
...
trait_hydrology_coef_CI <- Model_trait_hydrology_trait$stderr.coefficients[(nlines-3):nlines,]*qnorm(0.975)
...
coefs_PC1 <- c(trait_urb_coef[c(1)],
               ...
               trait_water_quality_coef[c(1,3)],
               trait_hydrology_coef[c(1,3)])
CI_PC1 <- c(trait_urb_coef_CI[c(1)],
            trait_structural_complexity_coef_CI[c(1,3)],
            trait_water_quality_coef_CI[c(1,3)],
            trait_hydrology_coef_CI[c(1,3)])

coefs_PC2 <- c(trait_urb_coef[c(2)],
               trait_structural_complexity_coef[c(2,4)],
               trait_water_quality_coef[c(2,4)],
               trait_hydrology_coef[c(2,4)])
CI_PC2 <- c(trait_urb_coef_CI[c(2)],
            trait_structural_complexity_coef_CI[c(2,4)],
            trait_water_quality_coef_CI[c(2,4)],
            trait_hydrology_coef_CI[c(2,4)])
