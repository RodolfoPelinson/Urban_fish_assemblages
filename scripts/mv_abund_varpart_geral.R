...
barplot(pure_scaleds, ylim = c(0,1), las = 2, col = c("#DBDB8D", "#AEC7E8", "#C49C94"), border = "transparent", xaxt = "n", xaxs = "i", width = 1, space = 0.5, xlim = c(0,20), yaxt = "n")
box(bty = "l")
names <- colnames(pure_scaleds)
names <- gsub("_"," ", names)
axis(1, at = at_generator(first = 1, spacing = 1.5, n = length(names)), gap.axis = -10, tick = TRUE, labels = names, las = 2, font = 3, line = 0)
...
title(xlab = "Urban cover", cex.lab = 1.5)
...
#Predictions Urbanization Environemntal Structure
est_PC1_coefs <- varpart_peixes$models$ambiente$coefficients[6,]
est_PC1_IC_coefs <- varpart_peixes$models$ambiente$stderr.coefficients[6,] * qnorm(0.975)
est_PC1_upper_coefs <- est_PC1_coefs + est_PC1_IC_coefs
est_PC1_lower_coefs <- est_PC1_coefs - est_PC1_IC_coefs

names <- names(est_PC1_coefs)
names <- gsub("_"," ", names)

dev.off()
par(mar = c(4,12,1,1))
My_coefplot(mles = est_PC1_coefs, upper = est_PC1_upper_coefs,
            lower = est_PC1_lower_coefs, col_sig = "#AEC7E8",
            cex_sig = 2, species_labels = names, yaxis_font = 3)
title(xlab = "Env. structure PC1", cex.lab = 1.5)
...
#Predictions Urbanization Environemntal Structure
est_PC2_coefs <- varpart_peixes$models$ambiente$coefficients[2,]
est_PC2_IC_coefs <- varpart_peixes$models$ambiente$stderr.coefficients[2,] * qnorm(0.975)
est_PC2_upper_coefs <- est_PC2_coefs + est_PC2_IC_coefs
est_PC2_lower_coefs <- est_PC2_coefs - est_PC2_IC_coefs

names <- names(est_PC2_coefs)
names <- gsub("_"," ", names)

dev.off()
par(mar = c(4,12,1,1))
My_coefplot(mles = est_PC2_coefs, upper = est_PC2_upper_coefs,
            lower = est_PC2_lower_coefs, col_sig = "#AEC7E8",
            cex_sig = 2, species_labels = names, yaxis_font = 3)
title(xlab = "Env. structure PC2", cex.lab = 1.5)
...
#Predictions Urbanization Environemntal Structure squared
est_PC2_coefs <- varpart_peixes$models$ambiente$coefficients[3,]
est_PC2_IC_coefs <- varpart_peixes$models$ambiente$stderr.coefficients[3,] * qnorm(0.975)
est_PC2_upper_coefs <- est_PC2_coefs + est_PC2_IC_coefs
est_PC2_lower_coefs <- est_PC2_coefs - est_PC2_IC_coefs
...
My_coefplot(mles = est_PC2_coefs, upper = est_PC2_upper_coefs,
            lower = est_PC2_lower_coefs, col_sig = "#AEC7E8",
            cex_sig = 2, species_labels = names, yaxis_font = 3)
title(xlab = "Env. structure PC2 squared", cex.lab = 1.5)
...
#Predictions Urbanization Environemntal Water basin
est_PC2_coefs <- varpart_peixes$models$ambiente$coefficients[4,]
est_PC2_IC_coefs <- varpart_peixes$models$ambiente$stderr.coefficients[4,] * qnorm(0.975)
est_PC2_upper_coefs <- est_PC2_coefs + est_PC2_IC_coefs
est_PC2_lower_coefs <- est_PC2_coefs - est_PC2_IC_coefs
...
My_coefplot(mles = est_PC2_coefs, upper = est_PC2_upper_coefs,
            lower = est_PC2_lower_coefs, col_sig = "#AEC7E8",
            cex_sig = 2, species_labels = names, yaxis_font = 3)
title(xlab = "Watershed PC1", cex.lab = 1.5)
...
#Predictions Urbanization Environemntal Water 
est_PC2_coefs <- varpart_peixes$models$ambiente$coefficients[5,]
est_PC2_IC_coefs <- varpart_peixes$models$ambiente$stderr.coefficients[5,] * qnorm(0.975)
est_PC2_upper_coefs <- est_PC2_coefs + est_PC2_IC_coefs
est_PC2_lower_coefs <- est_PC2_coefs - est_PC2_IC_coefs
...
My_coefplot(mles = est_PC2_coefs, upper = est_PC2_upper_coefs,
            lower = est_PC2_lower_coefs, col_sig = "#AEC7E8",
            cex_sig = 2, species_labels = names, yaxis_font = 3)
title(xlab = "WaterPC2", cex.lab = 1.5)
...
functional_singletons <- functional[match(colnames(singletons), rownames(functional)),]
...
Model_pred_null <- traitglm(L = assembleia_peixes_rm_funcional, R = urb, Q = NULL)
Model_pred_trait <- traitglm(L = assembleia_peixes_rm_funcional, R = urb, Q = data.frame(funcional_PCs[,1:3]))
